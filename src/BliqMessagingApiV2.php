...
use Bliq\Api\Exception\BliqApiResponseException;
use Bliq\Api\MessagingResults\SendResult;
use Bliq\Api\ValueObject\WhatsAppTemplate;

class BliqMessagingApiV2
{
    /**
     * @var string URL de conexión a la API.
     */
    const API_BASE_URL = 'https://api.reeply.mx/messaging/v2/';
    ...
    private function assertIsSuccessResponse(int $httpCode, array $response)
    {
        if ($httpCode < 200 || $httpCode >= 300) {
            ...
            throw new BliqApiResponseException($errMsg, $httpCode, $response);
        }
    }
}
